...
const timeline = [
  ...
  },
  {
    ...
    text: "All teams whose ideas have been accepted into getlinked tech hackathon 1.0 2023 are formally announced.",
    date: "November 18, 2023",
  },
  {
    number: "5",
    title: "Getlinked Hackathon 1.0 Officially Begins",
    text: "Accepted teams can now proceed to build their groundbreaking skill-driven solutions.",
    date: "November 18, 2023",
  },
  {
    number: "6",
          ...
          {timeline.map((item, index) => (
            ...
            >
              ...
              >
                ...
                <span className="text-[0.9em]">{item.text}</span>
              </motion.div>
